...
% Last Modified by GUIDE v2.5 22-Nov-2019 22:05:07
...
data_ekstraksi = getappdata(0,'dataocr');
[baris_eks,kolom_eks] = size(data_ekstraksi);
if baris_eks == 16
set(handles.uitable1,'data',data_ekstraksi,'ColumnWidth',{362},'ColumnName','Isi','RowName',{'Lokasi',' ','NIK','Nama','Tempat/Tgl Lahir','Jenis kelamin','Golongan Darah','Alamat','RT/RW','Kel/Desa','Kecamatan','Agama','Status Perkawinan','Pekerjaan','Kewarganegaraan','Berlaku Hingga'});
else
set(handles.uitable1,'data',data_ekstraksi,'ColumnWidth',{362},'ColumnName','Isi','RowName',{'Lokasi',' ','NIK','Nama','Tempat/Tgl Lahir','Jenis kelamin','Golongan Darah','Alamat',' ','RT/RW','Kel/Desa','Kecamatan','Agama','Status Perkawinan','Pekerjaan','Kewarganegaraan','Berlaku Hingga'});
end